...
namespace OpenCartTestingProject
{
    ...
    public class ChangeQuantityOfOrderedProductTest
    {
        ...
        public void ChangeQuantity_CorrectValue()
        {
            ...
            Double expectedTotal = Math.Round(shoppingCartPage.CalculateLineTotal(shoppingCartBO),1);
            Double actualTotal = Math.Round(shoppingCartPage.GetTotal(shoppingCartBO),1);
